...
namespace Mutations.Effects
{
    ...
    public class AlphaMuscularMinorEffect : StatModifierEffect
    {
        ...
        private int basePenetrationValue;
        ...
        protected override void ApplyStatModification(PlayerModel playerModel, int level)
        {
            ...
            if (stats != null)
            {
                ...
                basePenetrationValue = playerModel.BulletMaxPenetration;
                float bonusToApply = maxPenetration - basePenetrationValue;
        ...
        protected override void RemoveStatModification(PlayerModel playerModel)
        {
            ...
            if (stats != null)
            {
                ...
                stats.AddFlatBonus(playerModel.StatRefs.bulletMaxPenetration, -basePenetrationValue);
