	...
	SubShader
	{
		...
		Pass
		{
						 ...
						 ) : SV_Target
			{
				...
				float4 temp_output_39_0 = ( step( float4( 0.1415094,0.1415094,0.1415094,0 ) , tex2D( _TextureSample0, ( UVs83 * float2( 0.1,0.1 ) ) ) ) * color18 );
...
/*ASEBEGIN
Version=18900
0;476;1554;515;577.3788;1151.381;1;True;False
...
Node;AmplifyShaderEditor.GetLocalVarNode;84;-1348.146,-1117.368;Inherit;False;83;UVs;1;0;OBJECT;;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;155;-1064.477,-1051.274;Inherit;False;2;2;0;FLOAT2;0,0;False;1;FLOAT2;0.1,0.1;False;1;FLOAT2;0
...
Node;AmplifyShaderEditor.RangedFloatNode;156;120.6212,-944.3815;Inherit;False;Constant;_Float16;Float 16;3;0;Create;True;0;0;0;False;0;False;0.9;0;0;0;0;1;FLOAT;0
...
WireConnection;1;3;156;0
WireConnection;1;8;151;0
ASEEND*/
//CHKSM=6CDCE3C8DB6421C3042950F236A3F5764833676B